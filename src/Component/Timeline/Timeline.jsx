  ...
  return (
    ...
    >
      <div className="max-w-7xl w-full mx-auto py-12 md:pt-8 md:pb-0 px-4 md:px-8 lg:px-10 flex flex-col justify-center items-center">
        <h2 className="text-lg md:text-4xl mb-4 text-center text-black dark:text-white max-w-full uppercase tracking-[0.5rem] font-bold">
          Experience
        </h2>
        <hr
          style={{
        ...
        ></hr>
        <p className="text-neutral-700 text-center dark:text-neutral-300 text-sm md:text-xl mt-2 max-w-full" style={{fontFamily:"itim"}}>
          I&apos;ve been working on Rubico for the past 1.5 years. Here&apos;s
